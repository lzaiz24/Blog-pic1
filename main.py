# 来自 https://github.com/u21h2/yuque2md
import re
import requests
import os
import sys
...
def main():
    ...
    mkdir(image_dir)
    cnt = handler(origin_md_path, output_md_path, image_dir,
                  image_url_prefix, image_rename_mode)
